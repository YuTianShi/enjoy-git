...
final class PostProcessorRegistrationDelegate {
	...
	public static void registerBeanPostProcessors(
		...
		/**
		 * BeanPostProcessorChecker是一个普通的信息打野，可能会有些情况
		 * 当spring的配置中的后置处理器还没有被注册就已经开始了bean的初始化是，便会打印出
		...
		//第一步，注册所有实现Ordered的BeanPostProcessor
